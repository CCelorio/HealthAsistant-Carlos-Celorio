package com.example.healthassistant.Eleccion.SaludMental
...
class SaludMentalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (nombreUsuario != null) {
            val nombreUsuarioTextView = findViewById<TextView>(R.id.nombreUsuarioTextView3)
